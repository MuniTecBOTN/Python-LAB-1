...
cajas_de_texto = {"width": 180, "font": ("Montserrat", 16)}
...
# ------------------------------------------------------------------------------
frame_principal = CTkFrame(master=ventana, corner_radius=0)
...
frame_superior = CTkFrame(master=frame_principal, corner_radius=0)
...
frame_medio = CTkFrame(master=frame_principal, corner_radius=0)
...
frame_inferior = CTkFrame(master=frame_principal, corner_radius=0)
...
etiqueta_nombre_cine.grid(row=0, column=0, sticky="ewns")

etiqueta_pelicula = CTkLabel(master=frame_medio, text="pelicula:", **etiqueta_medio)
etiqueta_pelicula.grid(row=0, column=0, sticky="ew")
etiqueta_horario = CTkLabel(master=frame_medio, text="HORARIO", **etiqueta_medio)
etiqueta_horario.grid(row=1, column=0, sticky="ew")

etiqueta_boleto = CTkLabel(master=frame_medio, text="TIPO DEL BOLETO", **etiqueta_medio)
etiqueta_boleto.grid(row=2, column=0, sticky="ew")
etiqueta_cantidad = CTkLabel(master=frame_medio, text="CANTIDAD", **etiqueta_medio)
etiqueta_cantidad.grid(row=3, column=0, sticky="ew")
etiqueta_preciou = CTkLabel(
    master=frame_medio, text="PRECIO UNITARIO", **etiqueta_medio
)
etiqueta_preciou.grid(row=4, column=0, sticky="ew")
...
campo_texto_cantidad = CTkEntry(
    master=frame_medio, placeholder_text="Escriba la cantidad ", **cajas_de_texto
)
...
campo_texto_precio = CTkEntry(
    master=frame_medio, placeholder_text="el valor es", **cajas_de_texto
)
campo_texto_precio.grid(row=4, column=1)
campo_texto_precio = CTkEntry(
    master=frame_medio, placeholder_text="su total es", **cajas_de_texto
)
campo_texto_precio.grid(row=5, column=1)
